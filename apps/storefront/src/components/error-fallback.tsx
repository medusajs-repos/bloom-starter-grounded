              ...
              {showDetails && (
                <div className="mt-4 p-4 bg-neutral-50">
                  <div className="text-left space-y-3">
                    <div>
                      <p className="text-xs font-medium text-neutral-900 uppercase tracking-wide mb-1">
                        Error Message
                      </p>
                    ...
                    {error.stack && (
                      <div>
                        ...
                        <pre className="text-xs text-neutral-600 bg-white border border-neutral-300 p-3 overflow-auto max-h-40">
                          {error.stack}
                        </pre>
                      </div>
                    )}
