  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium text-neutral-900">Order ID:</span>
        <span className="text-sm text-neutral-600">
          {formatOrderId(`${order.display_id || order.id}`)}
        </span>
      </div>
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium text-neutral-900">Order Date:</span>
        <span className="text-sm text-neutral-600">
      ...
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium text-neutral-900">Order Status:</span>
        <span className="text-sm text-neutral-600">{order.status}</span>
      </div>
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium text-neutral-900">Order Email:</span>
        <span className="text-sm text-neutral-600">
  ...
  return (
    <div className="flex items-center gap-4 py-3 border-b border-neutral-200 last:border-b-0">
      ...
      <div className="flex-1 flex flex-col gap-y-1">
        <span className="text-base font-medium text-neutral-900">{item.product_title}</span>
        {item.variant_title && item.variant_title !== "Default Variant" && (
          <span className="text-sm text-neutral-600">{item.variant_title}</span>
        )}
        <span className="text-sm text-neutral-600">Quantity: {item.quantity}</span>
      </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between">
        <span className="text-neutral-900 text-sm">Total</span>
...
export const OrderShipping = ({ order }: OrderShippingProps) => {
  return (
    <div>
      <h3 className="mb-4 font-medium">Delivery Information</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <span className="text-base font-medium text-neutral-900 mb-2">
            Shipping Address
          </span>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <span className="text-base font-medium text-neutral-900 mb-2">Payment Method</span>
          <div className="text-sm text-neutral-600">
